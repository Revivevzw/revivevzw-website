...
export class HomeComponent implements OnInit {
    ...
    public $carrouselItems = this.carrouselApi.getCarrouselItems().pipe(map(x => x.map(y => Object.assign(y, { url: y.isEmbededYoutubeUrl ? this.buildYoutubeUrl(y.url.replace("&origin=https://www.revivevzw.be/", "")) : y.url })).filter(y => new Date(y.expDate) > new Date())));
